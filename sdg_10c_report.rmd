...
The analysis of the data cannot be done without tidying the data. The [data](https://databank.worldbank.org/source/remittance-prices-worldwide-(corridors)) provided by the 
```{r eval=FALSE}
####
####
