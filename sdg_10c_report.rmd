...
As previously stated, there are two components to SDG 10.C, the former being the reduction of global remittance cost to 3% and the latter being the reduction of average cost to 5%. To monitor this economic science, the World Bank has assembled the largest remittance database, which includes 141 unique countries and their remittance corridor rates based on the World Banks “Mystery shopping” methodology [REF BLOG POST].


## Library Installation

The following analysis uses several open R packages in order to 
```{r eval=FALSE}
####
####
